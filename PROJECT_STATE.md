...
LIVI v8.3.0 installé et démarré sans écran. Prochaine étape proposée : accès graphique distant, puis validation visuelle ; prototype MFi ensuite selon `docs/MFI_WIRING.md`. Le raccordement RP2040 est temporairement reporté.
